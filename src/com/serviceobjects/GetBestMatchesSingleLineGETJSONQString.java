...
@XmlRootElement(name = "GetBestMatchesSingleLine_GETJSONQString")
public class GetBestMatchesSingleLineGETJSONQString {

    @XmlElementRef(name = "BusinessName", namespace = "http://www.serviceobjects.com", type = JAXBElement.class, required = false)
